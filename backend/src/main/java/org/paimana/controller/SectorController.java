...
public class SectorController {
    ...
    public ApiResponse<List<Map<String, Object>>> getSectorStates(@PathVariable String sectorName) {
        return ApiResponse.ok(sectorService.getSectorStates(sectorName));
    }
    ...
    public ApiResponse<List<ProjectSummaryDto>> getSectorProjects(
        ...
        return ApiResponse.ok(sectorService.getSectorProjects(sectorName, state, page, size));
    }
}
