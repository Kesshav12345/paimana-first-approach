...
export const Methodology: React.FC = () => {
  ...
  const renderSectionContent = (id: string) => {
    switch (id) {
      case 'sec-1':
        return (
          <section id="sec-1" className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/90 shadow-sm space-y-5">
            <div className="flex items-center gap-3 text-blue-600">
              <Compass className="w-6 h-6" />
              <h2 className="text-xl font-bold text-slate-900">1. What PAIMANA-INTEL Does</h2>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 grid grid-cols-1 md:grid-cols-5 gap-3 text-center">
              <div className="p-3 bg-white rounded-lg border border-slate-200">
                <span className="text-xs font-bold text-blue-700 block mb-1">Official Facts</span>
                <span className="text-[11px] text-slate-500">MoSPI Flash Reports, Inception & Cabinet approvals</span>
              </div>
              ...
              <div className="p-3 bg-white rounded-lg border border-slate-200">
                ...
                <span className="text-[11px] text-slate-500">Multi-year monthly panel curves & trajectory velocity</span>
              </div>
              <div className="flex items-center justify-center text-slate-400 font-bold">+</div>
              <div className="p-3 bg-white rounded-lg border border-slate-200">
                <span className="text-xs font-bold text-purple-700 block mb-1">External Evidence</span>
                <span className="text-[11px] text-slate-500">PIB, Ministry releases, environmental & judicial signals</span>
              </div>
            </div>
            <div className="bg-blue-50/70 border-l-4 border-blue-600 p-4 rounded-r-lg text-xs text-blue-900 leading-relaxed flex items-start gap-3">
      ...
      case 'sec-2':
        return (
          <section id="sec-2" className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/90 shadow-sm space-y-5">
            <div className="flex items-center gap-3 text-indigo-600">
              <Layers className="w-6 h-6" />
              <h2 className="text-xl font-bold text-slate-900">2. System Architecture & Boundaries</h2>
            </div>
            <p className="text-slate-700 text-sm leading-relaxed">
            ...
            <div className="bg-slate-900 text-slate-200 p-6 rounded-xl border border-slate-800 space-y-4 text-xs font-mono">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-3 p-3 bg-slate-800/80 rounded-lg border border-slate-700">
                ...
                <span className="text-slate-400 text-[11px]">15-Area Project Intelligence, Operator Console, Analytics</span>
              </div>

              <div className="flex justify-center text-slate-500">↓ REST / JSON Contracts (Strict DTOs)</div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-3 p-3 bg-slate-800/80 rounded-lg border border-slate-700">
                ...
                <span className="text-slate-400 text-[11px]">Lifecycle Security, Job State, Transactional Boundaries</span>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                <div className="p-3 bg-slate-800/50 rounded-lg border border-slate-700">
                  <span className="text-purple-400 font-bold block mb-1">Canonical SQLite / Postgres</span>
                  <span className="text-slate-400 text-[11px]">Idempotent facts, cost revisions, quarantine, research snapshots</span>
                </div>
                <div className="p-3 bg-slate-800/50 rounded-lg border border-slate-700">
                  <span className="text-amber-400 font-bold block mb-1">Python FastAPI ML & Research Engine</span>
                  <span className="text-slate-400 text-[11px]">CatBoost MLOps, TreeSHAP, SearchProvider, ClaimExtractor</span>
                </div>
              </div>
            </div>
          </section>
      ...
      case 'sec-3':
        return (
          <section id="sec-3" className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/90 shadow-sm space-y-5">
            <div className="flex items-center gap-3 text-blue-600">
              <Workflow className="w-6 h-6" />
              <h2 className="text-xl font-bold text-slate-900">3. The 12-Stage Monthly Intelligence Lifecycle</h2>
            </div>
            <p className="text-slate-700 text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              {[
                ...
                <div key={idx} className="p-3 rounded-lg border border-slate-200 bg-slate-50/50 hover:bg-slate-50 transition-colors">
                  ...
                  <p className="text-slate-600 text-[11px] leading-relaxed pl-7">{item.desc}</p>
                </div>
              ))}
            </div>
          </section>
      ...
      case 'sec-4':
        return (
          <section id="sec-4" className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/90 shadow-sm space-y-5">
            <div className="flex items-center gap-3 text-emerald-600">
              <Database className="w-6 h-6" />
              <h2 className="text-xl font-bold text-slate-900">4. Data Foundation & Conceptual Tiers</h2>
            </div>
            <p className="text-slate-700 text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-xs">
              <div className="border border-amber-200 bg-amber-50/60 p-4 rounded-xl space-y-2">
                ...
                <h4 className="font-bold text-slate-900">Raw Source Artifacts</h4>
                <p className="text-slate-600 text-[11px]">
                  Immutable binary PDFs, raw parsed text segments, unmodified external HTML snippets, and source document hashes.
                </p>
              </div>

              <div className="border border-slate-300 bg-slate-50 p-4 rounded-xl space-y-2">
                <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-slate-200 text-slate-800">SILVER LAYER</span>
                <h4 className="font-bold text-slate-900">Canonical Standardized Data</h4>
                <p className="text-slate-600 text-[11px]">
              ...
              <div className="border border-blue-200 bg-blue-50/60 p-4 rounded-xl space-y-2">
                <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-blue-200 text-blue-900">GOLD LAYER</span>
                <h4 className="font-bold text-slate-900">Analytical Features</h4>
                <p className="text-slate-600 text-[11px]">
              ...
              <div className="border border-purple-200 bg-purple-50/60 p-4 rounded-xl space-y-2">
                ...
                <h4 className="font-bold text-slate-900">Decision Support Outputs</h4>
                <p className="text-slate-600 text-[11px]">
      ...
      case 'sec-5':
        return (
          <section id="sec-5" className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/90 shadow-sm space-y-6">
            <div className="flex items-center gap-3 text-blue-600">
              <BarChart2 className="w-6 h-6" />
              <h2 className="text-xl font-bold text-slate-900">5. Core Deterministic Metrics & Mathematics</h2>
            </div>
            <p className="text-slate-700 text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div className="p-4 rounded-xl border border-slate-200 bg-slate-50 space-y-2">
                <div className="flex items-center justify-between">
                  <span className="font-bold text-slate-900">Cost Escalation Percentage</span>
                  <span className="text-[10px] bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded font-mono">Formula</span>
                </div>
                <div className="bg-white p-2.5 rounded border border-slate-200 font-mono text-blue-900 text-[11px]">
              ...
              <div className="p-4 rounded-xl border border-slate-200 bg-slate-50 space-y-2">
                <div className="flex items-center justify-between">
                  <span className="font-bold text-slate-900">Physical-Financial Gap</span>
                  <span className="text-[10px] bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded font-mono">Formula</span>
                </div>
                <div className="bg-white p-2.5 rounded border border-slate-200 font-mono text-blue-900 text-[11px]">
              ...
              <div className="p-4 rounded-xl border border-slate-200 bg-slate-50 space-y-2">
                <div className="flex items-center justify-between">
                  <span className="font-bold text-slate-900">Progress Velocity (Velocity_3M)</span>
                  <span className="text-[10px] bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded font-mono">Formula</span>
                </div>
                <div className="bg-white p-2.5 rounded border border-slate-200 font-mono text-blue-900 text-[11px]">
              ...
              <div className="p-4 rounded-xl border border-slate-200 bg-slate-50 space-y-2">
                <div className="flex items-center justify-between">
                  <span className="font-bold text-slate-900">Schedule Slippage (Months)</span>
                  <span className="text-[10px] bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded font-mono">Formula</span>
                </div>
                <div className="bg-white p-2.5 rounded border border-slate-200 font-mono text-blue-900 text-[11px]">
      ...
      case 'sec-6':
        return (
          <section id="sec-6" className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/90 shadow-sm space-y-5">
            <div className="flex items-center gap-3 text-amber-600">
              <AlertTriangle className="w-6 h-6" />
              <h2 className="text-xl font-bold text-slate-900">6. Early Warning Generation & Persistence</h2>
            </div>
            <p className="text-slate-700 text-sm leading-relaxed">
            ...
            <div className="space-y-3 text-xs">
              <div className="p-3 rounded-lg border border-slate-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                <div>
                  <strong className="text-slate-900 block">Severe Cost Escalation Alert</strong>
                  <span className="text-slate-600 text-[11px]">Triggered when Revised Cost &gt; Original Cost by &ge; 50% or ₹1,000 Crore</span>
                </div>
              ...
              <div className="p-3 rounded-lg border border-slate-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                <div>
                  <strong className="text-slate-900 block">Chronic Schedule Drift</strong>
                  <span className="text-slate-600 text-[11px]">Triggered when Schedule Slippage exceeds 36 months or 50% of sanctioned timeline</span>
                </div>
              ...
              <div className="p-3 rounded-lg border border-slate-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                <div>
                  <strong className="text-slate-900 block">Stagnation / Delivery Freeze</strong>
                  <span className="text-slate-600 text-[11px]">Physical progress change &lt; 0.5% over 3+ consecutive monthly reporting periods</span>
                </div>
              ...
              <div className="p-3 rounded-lg border border-slate-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                <div>
                  <strong className="text-slate-900 block">Physical-Financial Asymmetry</strong>
                  <span className="text-slate-600 text-[11px]">Financial expenditure &gt; 80% while certified physical completion &lt; 50%</span>
                </div>
      ...
      case 'sec-7':
        return (
          <section id="sec-7" className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/90 shadow-sm space-y-5">
            <div className="flex items-center gap-3 text-purple-600">
              <Cpu className="w-6 h-6" />
              <h2 className="text-xl font-bold text-slate-900">7. Machine Learning: CatBoost & TreeSHAP</h2>
            </div>
            <p className="text-slate-700 text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-2">
                <span className="font-bold text-slate-900 block">Dual Classifier & Regressor Architecture</span>
              ...
              <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-2">
                <span className="font-bold text-slate-900 block">TreeSHAP Local Explainability</span>
                <p className="text-slate-600 text-[11px] leading-relaxed">
      ...
      case 'sec-8':
        return (
          <section id="sec-8" className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/90 shadow-sm space-y-6">
            <div className="flex items-center gap-3 text-blue-600">
              <Search className="w-6 h-6" />
              <h2 className="text-xl font-bold text-slate-900">8. External Intelligence Subsystem & Trust Hierarchy</h2>
            </div>
            <p className="text-slate-700 text-sm leading-relaxed">
            ...
            <div className="border border-slate-200 rounded-xl overflow-hidden text-xs">
              <div className="bg-slate-100 p-3 font-bold text-slate-800 border-b border-slate-200 flex justify-between">
                <span>5-Tier Evidence Source Trust Hierarchy</span>
                <span className="text-[11px] text-slate-500 font-normal">Methodology v2.4</span>
              </div>
              <div className="divide-y divide-slate-200 bg-white">
                <div className="p-3 flex items-start gap-4">
                  <span className="px-2 py-0.5 rounded bg-emerald-100 text-emerald-800 font-bold shrink-0">Tier 1 (0.98)</span>
                  <div>
                    <strong className="text-slate-900 block">Primary Authoritative Sources</strong>
                    <span className="text-slate-600 text-[11px]">PIB, Ministry Press Releases, Implementing Agency Portals (NHAI, RVNL, NTPC), Cabinet Decisions, Court Orders.</span>
                  </div>
                </div>
                <div className="p-3 flex items-start gap-4">
                  <span className="px-2 py-0.5 rounded bg-blue-100 text-blue-800 font-bold shrink-0">Tier 2 (0.85)</span>
                  <div>
                    <strong className="text-slate-900 block">Institutional Disclosures</strong>
                    <span className="text-slate-600 text-[11px]">Stock exchange filings (BSE/NSE), annual reports, multilateral lender releases (ADB, World Bank, JICA).</span>
                  </div>
                </div>
                <div className="p-3 flex items-start gap-4">
                  <span className="px-2 py-0.5 rounded bg-indigo-100 text-indigo-800 font-bold shrink-0">Tier 3 (0.70)</span>
                  <div>
                    <strong className="text-slate-900 block">High-Quality Investigative Journalism</strong>
                    <span className="text-slate-600 text-[11px]">Major business dailies, national newspapers, and specialist infrastructure engineering publications.</span>
                  </div>
                </div>
                <div className="p-3 flex items-start gap-4">
                  <span className="px-2 py-0.5 rounded bg-amber-100 text-amber-800 font-bold shrink-0">Tier 4 (0.45)</span>
                  <div>
                    <strong className="text-slate-900 block">Secondary Aggregators</strong>
                    <span className="text-slate-600 text-[11px]">General news portals, industry press digests. Used solely for lead discovery, never as sole authority.</span>
                  </div>
                </div>
                <div className="p-3 flex items-start gap-4">
                  <span className="px-2 py-0.5 rounded bg-slate-200 text-slate-700 font-bold shrink-0">Tier 5 (0.20)</span>
                  <div>
                    <strong className="text-slate-900 block">Unverified Web & Community Signals</strong>
                    <span className="text-slate-600 text-[11px]">Social media, local forums. Strictly quarantined; cannot independently establish project claims.</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      case 'sec-9':
        return (
          <section id="sec-9" className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/90 shadow-sm space-y-5">
            <div className="flex items-center gap-3 text-emerald-600">
              <ShieldCheck className="w-6 h-6" />
              <h2 className="text-xl font-bold text-slate-900">9. System-Wide Provenance & Trust</h2>
            </div>
            <p className="text-slate-700 text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center text-xs">
              <div className="p-3 rounded-lg border border-blue-200 bg-blue-50/60">
                <span className="font-bold text-blue-800 block text-[11px]">[OFFICIAL REPORT]</span>
                <span className="text-[10px] text-slate-500">MoSPI Flash Report / CPR extract</span>
              </div>
              <div className="p-3 rounded-lg border border-emerald-200 bg-emerald-50/60">
                ...
                <span className="text-[10px] text-slate-500">Mathematical formula calculation</span>
              </div>
              <div className="p-3 rounded-lg border border-purple-200 bg-purple-50/60">
                ...
                <span className="text-[10px] text-slate-500">ML probabilistic prediction</span>
              </div>
              <div className="p-3 rounded-lg border border-amber-200 bg-amber-50/60">
                ...
                <span className="text-[10px] text-slate-500">Web researched & ranked claim</span>
              </div>
            </div>
      ...
      case 'sec-10':
        return (
          <section id="sec-10" className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/90 shadow-sm space-y-5">
            <div className="flex items-center gap-3 text-blue-600">
              <FileCheck className="w-6 h-6" />
              <h2 className="text-xl font-bold text-slate-900">10. Data Quality Gates & Quarantine</h2>
            </div>
            <p className="text-slate-700 text-sm leading-relaxed">
      ...
      case 'sec-11':
        return (
          <section id="sec-11" className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/90 shadow-sm space-y-5">
            <div className="flex items-center gap-3 text-slate-800">
              <Activity className="w-6 h-6 text-blue-600" />
              <h2 className="text-xl font-bold text-slate-900">11. Operational Lifecycle: New Flash Report</h2>
            </div>
            <p className="text-slate-700 text-sm leading-relaxed">
      ...
      case 'sec-12':
        return (
          <section id="sec-12" className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/90 shadow-sm space-y-5">
            <div className="flex items-center gap-3 text-slate-800">
              <Clock className="w-6 h-6 text-amber-600" />
              <h2 className="text-xl font-bold text-slate-900">12. Limitations & Responsible Interpretation</h2>
            </div>
            <p className="text-slate-700 text-sm leading-relaxed">
  ...
  return (
    <div id="methodology-content-root" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
        {/* Navigation Sidebar */}
        <aside className="bg-white p-5 rounded-2xl border border-slate-200/90 shadow-sm space-y-3 lg:sticky lg:top-20">
          <div className="flex items-center justify-between px-1">
            ...
            <button
              ...
              className="inline-flex items-center gap-1 text-[10px] font-semibold text-slate-500 hover:text-blue-600 bg-slate-50 hover:bg-blue-50 px-2 py-0.5 rounded border border-slate-200 transition-colors"
              ...
              return (
                <button
                  ...
                  className={`w-full text-left px-3.5 py-2.5 rounded-xl text-xs transition-all flex items-center justify-between ${
                    isActive
                      ? 'border-2 border-blue-500 bg-blue-50/40 text-blue-600 font-bold shadow-sm'
                      : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50 border border-transparent font-medium'
                  }`}
                >
                  <span>{s.label}</span>
                  <ChevronRight className={`w-3.5 h-3.5 transition-transform ${isActive ? 'text-blue-600 translate-x-0.5' : 'text-slate-400'}`} />
                </button>
              );
            })}
          </div>
          ...
          <div className="pt-2 border-t border-slate-100">
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-200/70 text-[11px] text-slate-500 leading-relaxed">
              <span className="font-semibold text-slate-700 block mb-0.5">Auditable Rigor</span>
